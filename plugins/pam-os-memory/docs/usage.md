...
The skill config contains the PAM-OS REST URL, optional Basic Auth credentials, and request timeout. For local development, pass `--repo-dir /path/to/PAM-OS` or `--source /path/to/plugins/pam-os-memory` explicitly.
