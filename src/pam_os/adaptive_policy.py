        ...
        self._add_matches(
            ...
            text,
            {
                ...
                "identity_statement": [
                    ...
                    r"\buser(?:'s|s)? name is\b",
                    r"\bcall me\b",
                    r"\bplease call me\b",
                    r"\bmy role is\b",
                    r"\bi work as\b",
                    r"\bi(?:'m| am) based in\b",
                    r"\bi live in\b",
                    r"\bmy timezone is\b",
                    r"\bi speak\b",
                    r"\bthe user works as\b",
                    r"\buser works as\b",
                    r"\bthe user(?:'s)? role is\b",
                    r"\buser(?:'s)? role is\b",
                    r"\bthe user is based in\b",
                    r"\buser is based in\b",
                    r"\bthe user lives in\b",
                    r"\buser lives in\b",
                    "叫我",
                    "称呼我",
                    "我的职业",
                ...
                "preference_statement": [
                    ...
                    r"\bthey (?:like|prefer)\b",
                    r"\bthe user (?:likes|prefers)\b",
                    r"\buser (?:likes|prefers)\b",
                    r"\bi usually use\b",
                    r"\bi mainly use\b",
                    r"\bi mostly use\b",
                    r"\bi work mostly in\b",
                    r"\bmy usual stack is\b",
                    r"\bmy stack is\b",
                    r"\bthe user usually uses\b",
                    r"\buser usually uses\b",
                    "我平时用",
                    "我常用",
                    "我主要用",
                    "我的常用",
